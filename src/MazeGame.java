...
public class MazeGame {
	...
	public void newGame() throws Exception {
		...
		if (choice == 1 || choice == 2 || choice == 3) {
			...
			if (choice == 1) {
				file = new File("C://Users//AkifCkr//Desktop//Çalýþmalar//Eclipse Java//P2-EnergyMaze//src//maze.txt");
			} else if (choice == 2) {
				file = new File("C://Users//AkifCkr//Desktop//Çalýþmalar//Eclipse Java//P2-EnergyMaze//src//maze2.txt");
			} else if (choice == 3) {
				file = new File("C://Users//AkifCkr//Desktop//Çalýþmalar//Eclipse Java//P2-EnergyMaze//src//maze3.txt");
			}
